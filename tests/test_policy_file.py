...
# PATHS ______________________________________________________________________________________________________________________________
...
@pytest.fixture
def policy_template(): #load the template file
...
# TEMPLATE TESTS ______________________________________________________________________________________________________________________
...
def test_security_updates_subsections(policy_template):
    #check if the template file has the correct subsections under security updates
    content = policy_template
...
#GENERATED TESTS __________________________________________________________________________________________________________________________
